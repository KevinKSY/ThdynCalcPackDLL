  ...
  double *Cv, double *K)
{
  ...
  *s = FC11 * SS1;
  *u = *h - *R * T;
  *RF = FC11F * ZZ + FC11 * (FC7 * ((FC3F - FC2F * FC6) - FC2 * FC6F));
  *RP = FC11 * (FC7P * (FC3 - FC2 * FC6));
  *RT = FC11 * (-FC7 * ((FC3 - FC2 * FC6) * 0.001 / TT + FC2 * FC6T));
  *uF = (FC11F * T * HH + FC11 * T * ((-0.005026 + TT * (-0.383504 + TT *
    ...
    - *RF * T;
  *uP = FC11 * T * (-ZZT1 * TT / PP * 1.01972E-5) - *RP * T;
  *uT = (FC11 * (HH + T * ((PAT1 * 0.001 - ((FC7T * (FC2 * FC6 * ((1.0 + z) +
  ...
  *sF = FC11F * SS1 + FC11 * (((((-0.0659 * VF * log(T) + (0.55314 + TT *
    ...
    (9.20231E-5 - 2.99679E-6 * TT)))))) * VF) - (-0.400981 + V * (11.53978 +
    0.180168 * V)) * VF) - FC7 * FC2F * FC6 * FC8) - FC7 * FC2 * FC6F * FC8) -
    FC7 * FC2 * FC6 * FC8F);
  *sP = FC11 * (-1.01972E-5 / PP - FC7P * FC2 * FC6 * FC8);
  *sT = FC11 * (((((3.5566 - 0.0659 * V) / T + ((0.0583837 - 0.485001 * V) + TT *
    ((1.742698 + 0.1396366 * V) + TT * ((-1.354668 - 0.0086316 * V) + TT *
    ((0.436656 - 0.002774652 * V) + TT * ((0.064877 + 0.0004601155 * V) + TT *
    (0.003649404 - 1.798074E-5 * V)))))) * 0.001) - FC7T * FC2 * FC6 * FC8) -
                 FC7 * FC2 * FC6T * FC8) - FC7 * FC2 * FC6 * FC8T);
  *Cp = FC11 * (HH + TT * (-FC7 / TT * (FC3 - 4.0 * FC2 * FC6 * (FC8 * FC8 + FC4
    / FC5)) + PAT1));
  ...
  *uF, double *uP, double *uT, double *sF, double *sP, double *sT)
{
  ...
  *uF = (FC11F * T * HH + FC11 * T * ((-0.005026 + TT * (-0.383504 + TT *
    ...
    - *RF * T;
  *uP = FC11 * T * (-ZZT1 * TT / PP * 1.01972E-5) - *RP * T;
  *uT = (FC11 * (HH + T * (((EP1 + TT * (2.0 * EP2 + TT * (3.0 * EP3 + TT * (4.0
    * EP4 + TT * (5.0 * EP5 + TT * 6.0 * EP6))))) * 0.001 - ((FC7T * (FC2 * FC6 *
    ((1.0 + z) + 1.0) - FC3) / TT + FC7 * (FC2 * FC6T * ((1.0 + z) + 1.0) + FC2 *
    FC6 * FC8T) / TT) - FC7 * (FC2 * FC6 * ((1.0 + z) + 1.0) - FC3) / (TT * TT) *
             0.001) * TT) - ZZT1 * 0.001)) - *RT * T) - *R;
  *sF = FC11F * SS1 + FC11 * (((((-0.0659 * VF * log(T) + (0.55314 + TT *
    (-0.485001 + TT * (0.0698183 + TT * (-0.0028772 + TT * (-0.000693663 + TT *
    (9.20231E-5 - 2.99679E-6 * TT)))))) * VF) - (-0.400981 + V * (11.53978 +
...
/* End of code generation (GetThdynCombGasZachV1.cpp) */
