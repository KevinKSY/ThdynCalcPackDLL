            ...
            double *p, double *T, double *F)
{
  ...
  *p = m * 300.0 * T_prev / V;
  err_p = 1.0;
  while (err_p > 0.01) {
    GetThdynCombGasZachV1(*p, T_prev, *F, fs, &R_temp, &unusedUf, &unusedU10,
                          &unusedU11, &unusedU12, &unusedU13, &unusedU14,
                          &unusedU15, &unusedU16, &unusedU17, &unusedU18,
                          &unusedU19, &unusedU1a, &unusedU1b, &unusedUd,
                          &unusedUe);
    p_temp = m * R_temp * T_prev / V;
